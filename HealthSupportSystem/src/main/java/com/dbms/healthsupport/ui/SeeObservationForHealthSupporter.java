...
public class SeeObservationForHealthSupporter extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SeeObservationForHealthSupporter frame = new SeeObservationForHealthSupporter("P2","P3");
	 ...
	 * Create the frame.
	 */
	public SeeObservationForHealthSupporter(String currPatientSSN, String currHSSSN) {
		...
		for(Integer observation: observations)
		{
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(SeeObservationForHealthSupporter.this,
				    e.getMessage(),
				    "Inane warning",
